...
当前版本是 `v0.1.7` Windows Pre-release。它已经完成桌面 MVP 的端到端闭环，并开始针对对话后的编码任务质量补强，但仍是未签名的私测版本。
...
- [Mimodex v0.1.7 Windows Pre-release](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.7)
- 安装包：`Mimodex_0.1.7_x64-setup.exe`
...
运行 `Mimodex_0.1.7_x64-setup.exe`，按安装器提示完成安装。
...
- [Mimodex v0.1.7](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.7)
...
`v0.1.7` 已完成桌面 MVP 功能闭环，并补强 Agent 任务执行指令与 MiMo thinking 策略。
当前重点是 Windows 11 私测验收、阻断缺陷修复、安全脱敏、动作与变更关联、发布冒烟和代码签名准备。最新状态以
