...
当前版本是 `v0.1.4` Windows Pre-release。它已经完成桌面 MVP 的端到端闭环，但仍是未签名的私测版本。
...
- 安装包：`Mimodex_0.1.4_x64-setup.exe`
- 大小：`57.91 MiB`
...
运行 `Mimodex_0.1.4_x64-setup.exe`，按安装器提示完成安装。
...
- [Mimodex v0.1.4](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.4)
...
`v0.1.4` 已完成桌面 MVP 功能闭环，当前重点是 Windows 11 私测验收、阻断缺陷修复、
