...
- 状态：桌面 MVP 功能闭环已建立，`v0.1.1` Windows Pre-release 已发布
- 最新 Windows Release 构建提交：`855512757d2dfcd3155f965a405e9b8a7e6713a2`
- 最后更新：2026-06-16
- 当前版本：`v0.1.1` Windows Pre-release
...
| 项目 | 结果 |
| --- | --- |
| Windows Release 构建提交 | `855512757d2dfcd3155f965a405e9b8a7e6713a2` |
| Windows Release | [#27585747825](https://github.com/MorganArthur/mimodex/actions/runs/27585747825)，成功 |
| GitHub Pre-release | [Mimodex v0.1.1](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.1) |
| 安装包 | `Mimodex_0.1.1_x64-setup.exe`，未签名 NSIS x64 |
| 安装包大小 | `57.87 MiB` |
| SHA256 | `EE181BE4E4DB8C1D8B74091CEE391C9067A6916092940820BF1CF5175E61B003` |
