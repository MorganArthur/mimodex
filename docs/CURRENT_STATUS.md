...
- 状态：桌面 MVP 功能闭环已建立，`v0.1.0` Windows Pre-release 已发布
- 最新 Windows Release 构建提交：`f0f3a877f78ab2be2dbbb89a33082a79b6c3e089`
- 最后更新：2026-06-13
- 当前版本：`v0.1.0` Windows Pre-release
...
| 项目 | 结果 |
| --- | --- |
| Windows Release 构建提交 | `f0f3a877f78ab2be2dbbb89a33082a79b6c3e089` |
| Windows Release | [#27472023953](https://github.com/MorganArthur/mimodex/actions/runs/27472023953)，成功 |
| GitHub Pre-release | [Mimodex v0.1.0](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.0) |
| 安装包 | `Mimodex_0.1.0_x64-setup.exe`，未签名 NSIS x64 |
| 安装包大小 | `57.79 MiB` |
| SHA256 | `3492F4C9116113A01CE5EEF662923B38C2B5C638E014FF70B809C654E6B55B2A` |
