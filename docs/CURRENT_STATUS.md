...
- 状态：桌面 MVP 功能闭环已建立，`v0.1.2` Windows Pre-release 发布中
- 最新 Windows Release 构建提交：`v0.1.2` 标签提交
- 最后更新：2026-06-16
- 当前版本：`v0.1.2` Windows Pre-release
...
| 项目 | 结果 |
| --- | --- |
| Windows Release 构建提交 | `v0.1.2` 标签提交 |
| Windows Release | 标签推送后由 `Windows Release` 工作流生成 |
| GitHub Pre-release | [Mimodex v0.1.2](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.2) |
| 安装包 | `Mimodex_0.1.2_x64-setup.exe`，未签名 NSIS x64 |
