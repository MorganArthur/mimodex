...
- 状态：桌面 MVP 功能闭环已建立，进入 Windows 11 私测准入验收
- 最新 Windows 构建提交：`6c09352efccd504173c178e81b5c152ff60de754`
- 最后更新：2026-06-13
- 当前版本：`0.1.0` Windows Preview
...
项目、创建与恢复线程、流式对话、执行 Agent 工具、处理审批、审阅 Git Diff，并在
...
| 项目 | 结果 |
| --- | --- |
| Windows 构建提交 | `6c09352efccd504173c178e81b5c152ff60de754` |
| Desktop CI | [#27449796224](https://github.com/MorganArthur/mimodex/actions/runs/27449796224)，成功 |
| Windows Preview | [#27449796215](https://github.com/MorganArthur/mimodex/actions/runs/27449796215)，成功 |
| Artifact | [mimodex-windows-preview-6c09352](https://github.com/MorganArthur/mimodex/actions/runs/27449796215/artifacts/7605689013) |
| 安装包 | `Mimodex_0.1.0_x64-setup.exe`，未签名 NSIS x64 |
| 安装包大小 | `57.76 MiB` |
| SHA256 | `DE138717BECCAFBA419DB768FA7C62C07632BA1292E8F6725BB5F0B66E8579A4` |

Windows Preview 已通过 TypeScript、React、Tauri Rust 格式与编译检查、SQLite
...
- 本地无需安装 Rust；
- Desktop CI、Runtime CI、Provider Spike CI 与 Windows Preview 工作流；
...
- Windows 代码签名与受保护的正式 Release 工作流；
