...
- 状态：桌面 MVP 功能闭环已建立，`v0.1.4` Windows Pre-release 发布中
- 最新 Windows Release 构建提交：`v0.1.4` 标签提交，Actions run 待生成
- 最后更新：2026-06-16
- 当前版本：`v0.1.4` Windows Pre-release
...
| 项目 | 结果 |
| --- | --- |
| Windows Release 构建提交 | `v0.1.4` 标签提交 |
| Windows Release | [Windows Release 待生成](https://github.com/MorganArthur/mimodex/actions) |
| GitHub Pre-release | [Mimodex v0.1.4](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.4) |
| 安装包 | `Mimodex_0.1.4_x64-setup.exe`，未签名 NSIS x64 |
| 安装包大小 | 以 GitHub Release 页面为准 |
| SHA256 | 以 GitHub Release 页面为准 |

Windows Release 预计执行版本标签校验、TypeScript、React、Tauri Rust 格式与编译检查、SQLite
