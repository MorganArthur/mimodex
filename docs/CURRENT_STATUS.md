...
- 状态：桌面 MVP 功能闭环已建立，正在发布 `v0.1.1` Windows Pre-release
- 最新 Windows Release 构建提交：待 `v0.1.1` Release workflow 完成后更新
- 最后更新：2026-06-16
...
| 项目 | 结果 |
| --- | --- |
| Windows Release 构建提交 | 待发布完成后更新 |
| Windows Release | 待发布完成后更新 |
