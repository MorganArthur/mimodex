...
- 状态：桌面 MVP 功能闭环已建立，`v0.1.4` Windows Pre-release 已发布
- 最新 Windows Release 构建提交：`v0.1.4` 标签提交，Actions run `27604579174`
- 最后更新：2026-06-16
...
| Windows Release | [Windows Release #27604579174](https://github.com/MorganArthur/mimodex/actions/runs/27604579174) |
...
| 安装包大小 | `57.91 MiB` |
| SHA256 | `AA339BA0C2927FAA628FD1089995D41A5360DB88CEFB0BA596EC0B380679B31F` |
