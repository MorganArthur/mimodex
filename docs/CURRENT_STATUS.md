...
- 状态：桌面 MVP 功能闭环已建立，`v0.1.5` Windows Pre-release 准备发布
- 最新 Windows Release 构建提交：即将由 `v0.1.5` 标签触发
- 最后更新：2026-06-17
...
| 项目 | 结果 |
| --- | --- |
| Windows Release 构建提交 | `v0.1.5` 标签提交 |
| Windows Release | 待 GitHub Actions 生成 |
| GitHub Pre-release | [Mimodex v0.1.5](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.5) |
| 安装包 | `Mimodex_0.1.5_x64-setup.exe`，未签名 NSIS x64 |
