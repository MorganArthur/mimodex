...
当前长期可下载版本为
[Mimodex v0.1.2 Windows Pre-release](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.2)，
由 `v0.1.2` 标签触发 Windows Release 工作流构建并发布。安装包大小和 SHA256
以 GitHub Release 页面为准，当前未进行代码签名。
