...
当前长期可下载版本为
[Mimodex v0.1.1 Windows Pre-release](https://github.com/MorganArthur/mimodex/releases/tag/v0.1.1)，
由 [Windows Release #27585747825](https://github.com/MorganArthur/mimodex/actions/runs/27585747825)
成功构建并发布。安装包大小为 `57.87 MiB`，当前未进行代码签名。
