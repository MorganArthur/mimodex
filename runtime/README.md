...
4. 构建 Mimodex Runtime sidecar、Tauri 桌面程序和 Windows NSIS 安装包。
...
截至 2026-06-13，补丁队列包含 9 个补丁，已支持 MiMo 基础流、工具循环、恢复、
可空 SSE 集合、专属身份、简单对话快速路径和可配置 Base URL。当前状态与最新构建见
