      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-dark-400 text-lg max-w-xl mx-auto">
            当前版本 v0.2.2 Windows Pre-release
          </p>
        </div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-dark-500 text-sm">Mimodex_0.2.2_x64-setup.exe</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex justify-between py-2 border-b border-dark-800">
                ...
                <span className="text-white text-sm font-mono">v0.2.2</span>
              </div>
              <div className="flex justify-between py-2 border-b border-dark-800">
            ...
            <a
              href="https://github.com/MorganArthur/mimodex/releases/tag/v0.2.2"
              target="_blank"
